        ...
        {isReset ? (
          ...
          <form onSubmit={isSignUp ? handleSignUp : handleLogin} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-brand-card hover:bg-brand-surface text-brand-text font-semibold py-3 rounded-xl transition-all flex items-center justify-center gap-2 mt-4 cursor-pointer shadow-lg disabled:opacity-50"
            >
