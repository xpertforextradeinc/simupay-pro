  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="border-b border-brand-border/60 pb-5">
        <h2 className="text-2xl font-display font-bold text-brand-text tracking-tight flex items-center gap-2">
          <Database className="w-6 h-6 text-brand-accent" /> Database Cluster Status
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-4">
          {!isDbInitialized ? (
            <div className="bg-amber-950/10 border border-amber-500/30 rounded-2xl p-6 space-y-4 shadow-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-bold text-brand-text uppercase tracking-wider">Initialization Required</h3>
              ...
              <div className="space-y-3 text-xs text-[#9CB1AC] leading-relaxed font-sans">
                ...
                <p className="bg-brand-surface/30 p-3 rounded-lg border border-brand-border text-brand-text font-medium">
            ...
            <div className="bg-emerald-950/10 border border-emerald-500/20 rounded-2xl p-6 space-y-4 shadow-xl">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-brand-accent/10 rounded-xl border border-brand-accent/25 text-brand-accent">
                  <CheckCircle2 className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-brand-text uppercase tracking-wider">Database Verified & Active</h3>
                  <p className="text-[10px] text-brand-accent font-mono">STATUS: SYNCHRONIZED</p>
                </div>
              </div>
          ...
          <div className="bg-brand-card border border-brand-border/40 rounded-2xl p-6 space-y-4">
            <h3 className="text-sm font-bold text-brand-text flex items-center gap-2">
              <Activity className="w-4 h-4 text-brand-accent" /> System Telemetry & Logs
            </h3>
            <div className="space-y-2 font-mono text-[11px] text-[#9CB1AC]">
              <div className="flex justify-between border-b border-brand-border/30 pb-2">
                ...
                <span className="text-brand-text">Supabase JS client-v2</span>
              </div>
              <div className="flex justify-between border-b border-brand-border/30 pb-2">
        ...
        <div className="space-y-4">
          <div className="bg-brand-card p-5 rounded-2xl border border-brand-border shadow-xl space-y-4">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center gap-2 text-brand-text-muted">
                <div className={`w-2 h-2 rounded-full ${isDbInitialized ? 'bg-brand-accent' : 'bg-amber-500 animate-pulse'}`} />
          ...
          <div className="bg-brand-card/40 border border-brand-border/80 p-4.5 rounded-2xl flex items-start gap-3">
            <ShieldAlert className="w-5 h-5 text-brand-text-dim shrink-0 mt-0.5" />
            <div className="text-[11px] text-[#9CB1AC] space-y-1">
              <span className="font-bold text-brand-text block">Strict Security Policy</span>
